 ...
 */
package JButton1;
import static JButton1.Update_Product.*;
import javax.swing.*;
 ...
 * @author yugjh
 */
class InsertOrders implements ActionListener {
    ...
    InsertOrders()
    {
        ...
        ImageIcon image1=new ImageIcon("orders_logo.jpg");
        JPanel panel=new JPanel();
        JLabel label=new JLabel();
        
       panel.setBackground(new Color(0x00243e));
       panel.setBounds(0, 0, 1300, 200);
      ...
      try{
            ...
            BufferedWriter writer=new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream("demo2.txt",true))
            );
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                // SAME SPACING AS YOUR ORIGINAL FORMAT
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==button5)
        {
            ...
            String sql="insert into orders values("+o_id+","+"'"+o_type+"'"+","+p_id+","+c_id+","+o_quantity+")"  ;
            stmt.executeUpdate(sql);
           System.out.println("Order Quantity:"+o_quantity);
           button5.setEnabled(false);
           JOptionPane.showMessageDialog(frame,"VALUE INSERTED SUCCESSFULLY IN DATABASE...");
            ResultSet rs = stmt.executeQuery("SELECT p_stock FROM product WHERE p_id ="+p_id);
            int p_id2=0;
            while(rs.next()){
                p_id2 = rs.getInt("p_stock");
            }
            int ns=p_id2-o_quantity;
            String sql1="Update Product set p_stock="+ns+" where p_id="+p_id;
...
public class JButtonOrders {
    public static void main(String[] args) throws IOException {
        InsertOrders or=new InsertOrders();
        Update_Customer uc=new Update_Customer(4);
       // uc.display();
